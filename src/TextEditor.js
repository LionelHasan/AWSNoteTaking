...
function TextEditor( ) {
    ...
    const onSaveNote = async () => {
        ...
        console.log(newNote);
        const res = await fetch(`https://si43ha6zkkuq3pr3ja7pf4t7zu0xfpbt.lambda-url.ca-central-1.on.aws/?email=${profile.email}&id=${newNote.id}`, //CHANGE TO YOUR LAMBDA-URL
